package com.raillylinker.module_idp_mongodb.configurations.mongo_db_configs
...
import com.raillylinker.module_idp_mongodb.const_objects.ProjectConst

// [MongoDB 설정]
@Configuration
@EnableMongoRepositories(
    basePackages = ["${ProjectConst.PACKAGE_NAME}.mongo_db_beans.${Mdb1MainConfig.MONGO_DB_DIRECTORY_NAME}.repositories"],
