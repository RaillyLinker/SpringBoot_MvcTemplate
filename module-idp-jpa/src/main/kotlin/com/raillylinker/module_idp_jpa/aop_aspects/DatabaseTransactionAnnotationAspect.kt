package com.raillylinker.module_idp_jpa.aop_aspects
...
class DatabaseTransactionAnnotationAspect(
    ...
    @Around(com.raillylinker.module_idp_jpa.aop_aspects.DatabaseTransactionAnnotationAspect.Companion.TRANSACTION_ANNOTATION_PATH)
    fun aroundTransactionAnnotationFunction(joinPoint: ProceedingJoinPoint): Any? {
        ...
        try {
            ...
            for (transactionManagerBeanName in ((joinPoint.signature as MethodSignature).method).getAnnotation(
                com.raillylinker.module_idp_jpa.annotations.CustomTransactional::class.java
