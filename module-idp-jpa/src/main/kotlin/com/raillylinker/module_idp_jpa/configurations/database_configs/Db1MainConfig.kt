package com.raillylinker.module_idp_jpa.configurations.database_configs

import com.raillylinker.module_idp_jpa.const_objects.ProjectConst
...
@EnableJpaRepositories(
    ...
    basePackages = ["${ProjectConst.PACKAGE_NAME}.jpa_beans.${Db1MainConfig.DATABASE_DIRECTORY_NAME}.repositories"],
...
class Db1MainConfig(
    ...
    fun customEntityManagerFactory(): LocalContainerEntityManagerFactoryBean {
        ...
        em.setPackagesToScan("${ProjectConst.PACKAGE_NAME}.jpa_beans.${DATABASE_DIRECTORY_NAME}.entities")
