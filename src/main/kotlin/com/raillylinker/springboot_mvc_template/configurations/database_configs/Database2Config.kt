...
@EnableJpaRepositories(
    ...
    basePackages = [Database2Config.REPOSITORY_PATH],
    entityManagerFactoryRef = Database2Config.LOCAL_CONTAINER_ENTITY_MANAGER_FACTORY_BEAN_NAME, // 아래 bean 이름과 동일
    transactionManagerRef = Database2Config.TRANSACTION_NAME // 아래 bean 이름과 동일
)
class Database2Config(
    private val environment: Environment
) {
    companion object {
        // !!!application.yml 에 정의된 datasource 내의 DB명 작성!!!
        const val DATASOURCE_NAME: String = "database2"
