...
@Comment("회원 정보 테이블")
class Db0_RaillyLinkerCompany_CompanyMemberData(
    ...
    var companyMemberRoleDataList: MutableList<Db0_RaillyLinkerCompany_CompanyMemberRoleData> = mutableListOf()

    @OneToMany(mappedBy = "companyMemberData", fetch = FetchType.LAZY, cascade = [CascadeType.ALL])
    var companyMemberLockHistoryList: MutableList<Db0_RaillyLinkerCompany_CompanyMemberLockHistory> =
        mutableListOf()
