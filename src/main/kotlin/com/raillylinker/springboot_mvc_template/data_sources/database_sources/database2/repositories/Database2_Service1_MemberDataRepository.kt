...
@Repository
interface Database2_Service1_MemberDataRepository : JpaRepository<Database2_Service1_MemberData, Long> {
    fun existsByAccountId(accountId: String): Boolean

    fun findByAccountId(accountId: String): Database2_Service1_MemberData?
}