...
@Repository
interface Db0_RaillyLinkerCompany_CompanyMemberLockHistory_Repository :
    JpaRepository<Db0_RaillyLinkerCompany_CompanyMemberLockHistory, Long> {
    @Query(
        """
            SELECT 
            b 
            FROM 
            Db0_RaillyLinkerCompany_CompanyMemberLockHistory b 
            WHERE 
    ...
    fun findAllNowLocks(
        @Param("companyMemberData") companyMemberData: Db0_RaillyLinkerCompany_CompanyMemberData,
        @Param("currentTime") currentTime: LocalDateTime
    ): List<Db0_RaillyLinkerCompany_CompanyMemberLockHistory>
}