...
@Entity
@Table(name = "join_the_membership_with_oauth2_verification_data", catalog = "railly_linker_project1")
@Comment("OAuth2 회원가입 검증 테이블")
class Database1_RaillyLinkerProject1_JoinTheMembershipWithOauth2VerificationData(
