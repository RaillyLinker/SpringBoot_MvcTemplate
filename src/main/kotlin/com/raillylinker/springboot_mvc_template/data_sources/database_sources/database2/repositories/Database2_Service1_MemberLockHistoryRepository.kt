...
import com.raillylinker.springboot_mvc_template.data_sources.database_sources.database2.tables.Database2_Service1_MemberLockHistory
...
@Repository
interface Database2_Service1_MemberLockHistoryRepository :
    JpaRepository<Database2_Service1_MemberLockHistory, Long> {
    @Query(
        """
            SELECT 
            b 
            FROM 
            Database2_Service1_MemberLockHistory b 
            WHERE 
    ...
    ): List<Database2_Service1_MemberLockHistory>
}