...
@Entity
@Table(name = "member_profile_data", catalog = "railly_linker_project1")
@Comment("회원 프로필 정보 테이블")
class Database1_RaillyLinkerProject1_MemberProfileData(
    @ManyToOne
    @JoinColumn(name = "member_uid", nullable = false)
    @Comment("멤버 고유번호(RaillyLinkerProject1.member_data.uid)")
    var memberData: Database1_RaillyLinkerProject1_MemberData,
    ...
    var memberDataList: MutableList<Database1_RaillyLinkerProject1_MemberData> = mutableListOf()
