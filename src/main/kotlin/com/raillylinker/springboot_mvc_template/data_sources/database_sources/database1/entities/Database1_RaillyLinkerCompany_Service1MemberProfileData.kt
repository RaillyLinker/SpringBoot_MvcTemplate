...
class Database1_RaillyLinkerCompany_Service1MemberProfileData(
    @ManyToOne
    ...
    var service1MemberDataList: MutableList<Database1_RaillyLinkerCompany_Service1MemberData> = mutableListOf()
