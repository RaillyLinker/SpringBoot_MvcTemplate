...
@Repository
interface Database1_RaillyLinkerProject1_MemberDataRepository : JpaRepository<Database1_RaillyLinkerProject1_MemberData, Long> {
    fun existsByNickName(nickName: String): Boolean

    fun findByNickName(nickName: String): Database1_RaillyLinkerProject1_MemberData?
}