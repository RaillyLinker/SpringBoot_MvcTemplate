...
@Entity
@Table(name = "join_the_membership_with_email_verification_data", catalog = "railly_linker_project1")
@Comment("이메일 회원가입 검증 테이블")
class Database1_RaillyLinkerProject1_JoinTheMembershipWithEmailVerificationData(
