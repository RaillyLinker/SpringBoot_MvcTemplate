...
@Comment("회원 정보 테이블")
class Database0_RaillyLinkerCompany_MemberData(
    ...
    var memberRoleDataList: MutableList<Database0_RaillyLinkerCompany_MemberRoleData> = mutableListOf()

    @OneToMany(mappedBy = "memberData", fetch = FetchType.LAZY, cascade = [CascadeType.ALL])
    var memberLockHistoryList: MutableList<Database0_RaillyLinkerCompany_MemberLockHistory> = mutableListOf()
