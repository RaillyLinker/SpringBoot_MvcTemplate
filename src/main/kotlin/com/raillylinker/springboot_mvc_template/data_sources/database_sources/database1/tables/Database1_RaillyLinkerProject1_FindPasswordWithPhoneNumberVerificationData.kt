...
@Entity
@Table(name = "find_password_with_phone_number_verification_data", catalog = "railly_linker_project1")
@Comment("이메일로 비밀번호 찾기 검증 테이블")
class Database1_RaillyLinkerProject1_FindPasswordWithPhoneNumberVerificationData(
