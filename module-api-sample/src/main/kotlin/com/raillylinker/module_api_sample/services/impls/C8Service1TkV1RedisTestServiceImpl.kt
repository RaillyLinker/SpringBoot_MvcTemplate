...
import com.raillylinker.module_idp_redis.redis_beans.redis1_main.Redis1_Test
...
class C8Service1TkV1RedisTestServiceImpl(
    ...
    ////
    override fun api6RedisTransactionTest(
        httpServletResponse: HttpServletResponse,
    ...
    ////
    override fun api7RedisNonTransactionTest(
        httpServletResponse: HttpServletResponse,
